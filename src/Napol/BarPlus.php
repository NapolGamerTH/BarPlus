...
$bar = str_replace("{maxhp}", $maxhp, $bar);
$bar = str_replace("{hp}", $hp, $bar);
$bar = str_replace("{max_online}", $max_online, $bar);
$bar = str_replace("{online}", $online, $bar);
$bar = str_replace("{tps}", $tps, $bar);
$bar = str_replace("{usage}", $usage, $bar);
$bar = str_replace("{kills}", $kills, $bar);
